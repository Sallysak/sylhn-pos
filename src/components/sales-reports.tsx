...
export function SalesHistory({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div className="h-screen flex flex-col bg-slate-100">
      ...
      {/* Filter bar — premium mobile-friendly (hidden when printing) */}
      <div className="no-print flex-shrink-0 px-4 py-3 bg-white border-b border-slate-200 space-y-2">
      ...
      <div className="flex-1 overflow-hidden">
        <ScrollArea className="h-full">
          {/* ===== Desktop: traditional table (md+) — printable ===== */}

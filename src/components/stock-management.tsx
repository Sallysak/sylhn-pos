      ...
      <nav className="flex-shrink-0 bg-white border-b border-slate-200 shadow-sm">
        <div className="flex items-center gap-1.5 px-3 sm:px-6 py-2 overflow-x-auto scrollbar-hide">
          {[
            ...
            { id: "stock-transfer-popup" as const, label: "Stock Transfer", short: "Transfer", icon: Truck },
            { id: "history" as const, label: "Stock History", short: "History", icon: History },
          ].map(tab => {
            const isPopupTab = tab.id === "stock-file-popup" || tab.id === "stock-search-popup" || tab.id === "quantity-adjustment" || tab.id === "stock-transfer-popup";
            ...
            return (
              <button
                ...
                onClick={() => {
                  ...
                  else if (tab.id === "quantity-adjustment") setShowQtyAdjustmentPopup(true); else if (tab.id === "stock-transfer-popup") setShowTransfer(true);
                  else setView(tab.id);
                }}
                className={cn(

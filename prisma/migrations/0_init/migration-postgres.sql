-- PostgreSQL migration (sorted by dependencies)
...
CREATE TABLE "ForecastSnapshot" (
    ...
    "projectedStockoutDate" TIMESTAMP,
...
-- ===== SEED DEFAULT USERS =====
INSERT INTO "SystemUser" ("id", "username", "password", "fullName", "role", "phone", "email", "active", "permissions", "createdAt", "updatedAt")
VALUES
  (gen_random_uuid(), 'admin', 'admin123', 'System Administrator', 'admin', '', 'admin@sylhn.com', true, '{"pos":true,"sales":true,"stock":true,"purchase":true,"accounts":true,"telephone":true,"maintenance":true,"financeOps":true,"canVoid":true,"canDiscount":true,"canAdjustStock":true,"canDeleteProducts":true,"canExport":true}', NOW(), NOW()),
  (gen_random_uuid(), 'manager', 'manager123', 'Store Manager', 'manager', '', 'manager@sylhn.com', true, '{"pos":true,"sales":true,"stock":true,"purchase":true,"accounts":true,"telephone":true,"maintenance":false,"financeOps":true,"canVoid":true,"canDiscount":true,"canAdjustStock":true,"canDeleteProducts":false,"canExport":true}', NOW(), NOW()),
  (gen_random_uuid(), 'cashier', 'cashier123', 'Sarah Johnson', 'cashier', '', 'sarah@sylhn.com', true, '{"pos":true,"sales":true,"stock":false,"purchase":false,"accounts":false,"telephone":true,"maintenance":false,"financeOps":false,"canVoid":false,"canDiscount":true,"canAdjustStock":false,"canDeleteProducts":false,"canExport":false}', NOW(), NOW())
ON CONFLICT ("username") DO NOTHING;
-- ===== SEED DEFAULT SETTINGS =====
INSERT INTO "SystemSetting" ("id", "key", "value", "updatedAt", "updatedBy")
VALUES
  (gen_random_uuid(), 'companyName', 'SYLHN COMPANY LTD', NOW(), NULL),
  (gen_random_uuid(), 'taxRate', '0.15', NOW(), NULL),
  (gen_random_uuid(), 'taxName', 'VAT', NOW(), NULL),
  (gen_random_uuid(), 'currency', 'GHC', NOW(), NULL),
  (gen_random_uuid(), 'loyalty.pointsPerCedi', '1', NOW(), NULL),
  (gen_random_uuid(), 'loyalty.redeemRate', '0.05', NOW(), NULL),
  (gen_random_uuid(), 'loyalty.minRedeem', '100', NOW(), NULL)
